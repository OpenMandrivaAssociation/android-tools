...
ranlib libsparse.a
%{__cc} %{optflags} -DHOST -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE=1 -D_LARGEFILE_SOURCE=1 -Iinclude -o simg2img simg2img.c $(pkg-config --libs zlib) libsparse.a
%{__cc} %{optflags} -DHOST -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE=1 -D_LARGEFILE_SOURCE=1 -Iinclude -o img2simg img2simg.c $(pkg-config --libs zlib) libsparse.a
%{__cc} %{optflags} -DHOST -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE=1 -D_LARGEFILE_SOURCE=1 -Iinclude -o append2simg append2simg.c $(pkg-config --libs zlib) libsparse.a
...
for i in zip_archive.cc; do
	%{__cxx} -std=gnu++14 %{optflags} -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE=1 -D_LARGEFILE_SOURCE=1 -o ${i/.cc/.o} -c $i -I. -I../include -I../base/include
done
